"""Model training for fraud-sim dataset. Edited by the agent.

The harness calls train_and_evaluate(). Return predictions for val and OOT.
GPU is auto-detected and used when available.

NOTE: This dataset has 42% population shift in OOT. scale_pos_weight=1.0
(no class weighting) generalizes better than high class weights.
"""
